      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-xs-12 col-sm-4 col-md-6 col-lg-6 pull-left">
            <div class="dropdown block-language-wrapper"> <a role="button" data-toggle="dropdown" data-target="#" class="block-language dropdown-toggle" href="#"> <img src="{{ asset('public/frontend') }}/images/english.png" alt="language"> English <span class="caret"></span> </a>
