                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12">
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                <form class="page-form" action="{{ route('menu.store') }}" method="post" enctype="multipart/form-data" method="post" accept-charset="utf-8">
                                    @csrf
                                        ...
                                        <div class="col-md-8 col-sm-8">
                                            <select name="menu_of" id="" class="form-control js-example-basic-single" required>
                                                @foreach ($roles as $role)
                                                    <option value="{{ Str::lower($role->name) }}">{{ Str::ucfirst($role->name) }}</option>
                                                @endforeach
