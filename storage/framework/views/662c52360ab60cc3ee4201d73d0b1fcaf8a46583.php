                    ...
                    <div id='rev_slider_4' class='rev_slider fullwidthabanner'>
                        <ul>
                            <li data-transition='random' data-slotamount='7' data-masterspeed='1000' data-thumb='<?php echo e(asset('public/frontend')); ?>/images/slide-img1.jpg'>
                                ...
                                <div class="info">
                                    <div class='tp-caption ExtraLargeTitle sft  tp-resizeme ' data-endspeed='500' data-speed='500' data-start='1100' data-easing='Linear.easeNone' data-splitin='none' data-splitout='none' data-elementdelay='0.1' data-endelementdelay='0.1' style='z-index:2;max-width:auto;max-height:auto;white-space:nowrap;'><span>Todays Sale</span> </div>
                            ...
                            <li data-transition='random' data-slotamount='7' data-masterspeed='1000' data-thumb='<?php echo e(asset('public/frontend')); ?>/images/slide-img2.jpg'>
                                <img src='<?php echo e(asset('public/frontend')); ?>/images/slide-img2.jpg' alt="slide-img" data-bgposition='left top' data-bgfit='cover' data-bgrepeat='no-repeat' />
                                <div class="info">
...
<?php /**PATH C:\xampp\htdocs\green_glow\resources\views/frontend/layouts/home-slider.blade.php ENDPATH**/ ?>