      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-xs-12 col-sm-4 col-md-6 col-lg-6 pull-left">
            <div class="dropdown block-language-wrapper"> <a role="button" data-toggle="dropdown" data-target="#" class="block-language dropdown-toggle" href="#"> <img src="<?php echo e(asset('public/frontend')); ?>/images/english.png" alt="language"> English <span class="caret"></span> </a>
              <ul class="dropdown-menu" role="menu">
                <li role="presentation"> <a href="#"><img src="<?php echo e(asset('public/frontend')); ?>/images/english.png" alt="language"> English </a> </li>
              </ul>
            </div>
            <!-- End Header Language -->
            <!-- Header Currency -->
            <div class="dropdown block-currency-wrapper"> <a role="button" data-toggle="dropdown" data-target="#" class="block-currency dropdown-toggle" href="#"> PKR <span class="caret"></span></a>
              <ul class="dropdown-menu" role="menu">
          ...
          <div class="col-xs-12 col-sm-8 col-md-6 col-lg-6 pull-right hidden-xs">
            <div class="toplinks">
              <div class="links">
                ...
                <!-- End Header Company -->
                <div class="login"><a href="<?php echo e(route('login')); ?>"><span class="hidden-xs">Login</span></a> </div>
              </div>
            </div>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12 logo-block">
            <!-- Header Logo -->
            <div class="logo">
                <a title="Logo" href="<?php echo e(route('home')); ?>">
                    <img alt="Logo" src="<?php echo e(asset('public/frontend')); ?>/images/logo.png" style="width: 170px;">
                </a>
            </div>
            <!-- End Header Logo -->
        </div>
                  ...
                  <ul class="mini-products-list" id="cart-sidebar">
                    <li class="item first">
                      <div class="item-inner">
                        <a class="product-image" title="Retis lapen casen" href="#l">
                            <img alt="Retis lapen casen" src="<?php echo e(asset('public/frontend')); ?>/products-images/product4.jpg">
                        </a>
                    ...
                    <li class="item last">
                      <div class="item-inner"> <a class="product-image" title="Retis lapen casen" href="product_detail.html">
                        <img alt="Retis lapen casen" src="<?php echo e(asset('public/frontend')); ?>/products-images/product3.jpg"> </a>
                        <div class="product-details">
                          <div class="access"><a class="btn-remove1" title="Remove This Item" href="#">Remove</a>
                            <a class="btn-edit" title="Edit item" href="#"><i class="icon-pencil"></i><span class="hidden">Edit item</span></a> </div>
                          ...
                          <div class="col-md-4 has-sep hidden-sm">
                            <div class="custom-menu-right">
                              <div class="box-banner media">
                                <div class="add-right">
                                    <img src="<?php echo e(asset('public/frontend')); ?>/images/menu-img1.jpg"  alt="">
                                </div>
                              </div>
                            </div>
                          </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-4 has-sep hidden-sm">
                            <div class="custom-menu-right">
                              <div class="box-banner media">
                                <div class="add-right">
                                    <img src="<?php echo e(asset('public/frontend')); ?>/images/menu-img2.jpg" alt="">
                                </div>
                              </div>
                              <div class="box-banner media">
                                <div class="add-right">
                                    <img src="<?php echo e(asset('public/frontend')); ?>/images/menu-img3.jpg" alt="">
                                </div>
                              </div>
                            </div>
                          </div>
...
<?php /**PATH C:\xampp\htdocs\green_glow\resources\views/frontend/layouts/header.blade.php ENDPATH**/ ?>