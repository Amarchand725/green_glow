        ...
        <div class="col-xs-12 col-sm-4 col-md-6 col-lg-6 pull-left">
            <div class="dropdown block-language-wrapper">
                <a role="button" data-toggle="dropdown" data-target="#" class="block-language dropdown-toggle" href="#">
                    <img src="<?php echo e(asset('public/frontend/images/english.png')); ?>" alt="language"> English <span class="caret"></span>
                </a>
            <ul class="dropdown-menu" role="menu">
                <li role="presentation"> <a href="#"><img src="<?php echo e(asset('public/frontend/images/english.png')); ?>" alt="language"> English </a> </li>
                <li role="presentation"> <a href="#"><img src="<?php echo e(asset('public/frontend/images/francais.png')); ?>" alt="language"> French </a> </li>
                <li role="presentation"> <a href="#"><img src="<?php echo e(asset('public/frontend/images/german.png')); ?>" alt="language"> German </a> </li>
            </ul>
            </div>
            <!-- End Header Language -->
            <!-- Header Currency -->
    ...
    <div class="row">
        ...
        <div class="logo">
            <a title="Magento Commerce" href="index-2.html">
                <img alt="Magento Commerce" style="width:100px" src="<?php echo e(asset('public/frontend/images/logo.png')); ?>">
            </a>
        </div>
        <!-- End Header Logo -->
        </div>
        ...
        <div class="top-cart-contain">
            ...
            <div>
                ...
                <ul class="mini-products-list" id="cart-sidebar">
                    <li class="item first">
                    <div class="item-inner"> <a class="product-image" title="Retis lapen casen" href="#l">
                        <img alt="Retis lapen casen" src="<?php echo e(asset('public/frontend/products-images/product4.jpg')); ?>"> </a>
                    ...
                    <div class="popup">
                        ...
                        <div class="col-md-4 has-sep hidden-sm">
                            ...
                            <div class="box-banner media">
                                <div class="add-right"><img src="<?php echo e(asset('public/frontend/images/menu-img1.jpg')); ?>"  alt=""></div>
                            </div>
                            </div>
                        </div>
                        </div>
                ...
                <li> <a href="#"><i class="fa fa-suitcase"></i> Men</a>
                    ...
                    <div class="popup">
                        ...
                        <div class="col-md-4 has-sep hidden-sm">
                            <div class="custom-menu-right">
                            <div class="box-banner media">
                                <div class="add-right"><img src="<?php echo e(asset('public/frontend/images/menu-img2.jpg')); ?>" alt=""></div>
                            </div>
                            <div class="box-banner media">
                                <div class="add-right"><img src="<?php echo e(asset('public/frontend/images/menu-img3.jpg')); ?>" alt=""></div>
                            </div>
                            </div>
                        </div>
                        </div>
...
<?php /**PATH C:\xampp\htdocs\SolarEnergy\resources\views/frontend/layouts/header.blade.php ENDPATH**/ ?>