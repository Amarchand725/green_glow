<div class="container">
    ...
    <div class="blog-outer-container">
        ...
        <div class="col-lg-4 col-md-4 col-sm-4">
            <div class="entry-thumb image-hover2"> <a href="blog_single_post.html"> <img alt="Blog" src="<?php echo e(asset('public/frontend/images')); ?>/blog-img1.jpg"> </a> </div>
        ...
        <div class="col-lg-4 col-md-4 col-sm-4">
            <div class="entry-thumb image-hover2"> <a href="blog_single_post.html"> <img alt="Blog" src="<?php echo e(asset('public/frontend/images')); ?>/blog-img3.jpg"> </a> </div>
            <div class="blog-preview_info">
            <h4 class="blog-preview_title"><a href="blog_single_post.html">Standard blog post with photo</a></h4>
            <ul class="post-meta">
                <li><i class="fa fa-user"></i>posted by <a href="#">admin</a> </li>
        ...
        <div class="col-lg-4 col-md-4 col-sm-4">
            <div class="entry-thumb image-hover2"> <a href="blog_single_post.html"> <img alt="Blog" src="<?php echo e(asset('public/frontend/images')); ?>/blog-img2.jpg"> </a> </div>
            <div class="blog-preview_info">
            <h4 class="blog-preview_title"><a href="blog_single_post.html">Standard blog post with photo</a></h4>
            <ul class="post-meta">
                <li><i class="fa fa-user"></i>posted by <a href="#">admin</a> </li>
...
<?php /**PATH C:\xampp\htdocs\SolarEnergy\resources\views/frontend/layouts/blogs.blade.php ENDPATH**/ ?>