            ...
            <div class="row">
                <div class="col-md-12 col-sm-12">
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            <form class="page-form" action="<?php echo e(route('page.update', $model->slug)); ?>" method="post" novalidate>
                                <?php echo csrf_field(); ?>
                                ...
                                <div class="field item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <input class="form-control" data-validate-length-range="6" data-validate-words="2" name="title" value="<?php echo e($model->title); ?>" placeholder="Enter title" />
                                ...
                                <div class="field item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <input name="meta_title" class="form-control" value="<?php echo e($model->meta_title); ?>" placeholder="Enter title" data-validate-length-range="5,15" type="text" /></div>
                                </div>
                                ...
                                <div class="field item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <textarea class="form-control texteditor" name="description" maxlength="200" style="height:140px;" placeholder="Describe page"><?php echo $model->description; ?></textarea>
                                    </div>
                                </div>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\green_glow\resources\views/admin/page/edit.blade.php ENDPATH**/ ?>